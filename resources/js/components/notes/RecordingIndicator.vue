...
<template>
    <div>
        <button
            v-if="isRecording"
            type="button"
            class="fixed right-5 bottom-5 z-50 flex items-center gap-2.5 rounded-full bg-red-600 py-2.5 pr-5 pl-4 text-white shadow-xl transition-colors hover:bg-red-700"
            :title="
                recordingHasSystemAudio
